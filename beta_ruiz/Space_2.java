...
public class Space_2 extends JPanel
{ 
   ...
   public void fillBottomEnemies()
   {
      for (int x = 0; x < easyArray.length; x++)
      {
         if(x < 11)
         {
            easyArray[x] = new EasyEnemy(BFrame, 80*x, 0, x, 2);
            mediumArray[x] = new MediumEnemy(BFrame, 80*x, 0, x, 2);
         }
         else
         {
            easyArray[x] = new EasyEnemy(BFrame, 80*x + 45, 45,x, 2);
            mediumArray[x] = new MediumEnemy(BFrame, 80*x + 45, -45, x, 2);
         }
      }
   }
   ...
   public void fillHardArray()
   {
      ...
      {
         hardArray[x] = new HardEnemy(BFrame, 80*x, -45, x, 2);
      }      
   }

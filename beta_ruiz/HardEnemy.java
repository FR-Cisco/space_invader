...
public class HardEnemy extends JPanel implements Enemy
{
   /** background object */
   ...
   private BufferedImage myImage_30P;
   ...
   public HardEnemy(Background bkg, int valx, int valy, int id, int typ)
   {
      BFrame = bkg;
      point_x = STARTX + valx;
      point_y = STARTY + valy;
      ...
      try
      {
         myImage_30P = ImageIO.read(new File("30P-Ship.png"));
      }
      ...
      myImage_30P = getScaledImage(myImage_30P,50,50);
   }
   
   public void drawMe(Graphics2D g2)
   {
      g2.drawImage(myImage_30P, point_x, point_y, null);
   }
   
   public boolean checkInvade()
   {
      return invade;
   }
   ...
   public void hardSounds(int val) 
   {
      try 
      {
         if(val == 1)

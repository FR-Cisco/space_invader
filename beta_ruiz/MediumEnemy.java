...
public class MediumEnemy extends JPanel implements Enemy
{
   /** background object */
   ...
   private BufferedImage myImage_20B;
   ...
   public MediumEnemy (Background bkg, int valx, int valy, int id, int typ)
   {
      BFrame = bkg;
      point_x = STARTX + valx;
      point_y = STARTY + valy;
      ...
      try
      {
         myImage_20B = ImageIO.read(new File("20B-Ship.png"));
      }
      ...
      myImage_20B = getScaledImage(myImage_20B,50,50);
   }
   
   public void drawMe(Graphics2D g2)
   {
      g2.drawImage(myImage_20B, point_x, point_y, null);
   }
   ...
   {
      temp = 
         new Rectangle2D.Double(point_x +8, point_y, 35, 35);
   ...
   public void mediumSounds(int val) 
   {
      try 
      {
         if(val == 1)
   ...
   {
      temp = new Rectangle2D.Double(point_x +8, point_y, 
         100, 100);

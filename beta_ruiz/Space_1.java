...
public class Space_1 extends JPanel
{
   ...
   private int myMinutes_x;
   private int myMinutes_y;
   private int mySeconds_x;
   private int mySeconds_y;
   ...
   public Space_1(Background bkg)
   {
      ...
      easyArray = new EasyEnemy[11];
      mediumArray = new MediumEnemy[11];
   ...
   public void drawBackground(Graphics2D g2)
   {
      ...
      g2.drawString("Time " + myMinutes_x + myMinutes_y + ":" 
         + mySeconds_x + mySeconds_y, 400, 50);
   ...
   public void fillEasyArray()
   {
      for (int x = 0; x < easyArray.length; x++)
      {
         easyArray[x] = new EasyEnemy(BFrame, 80*x, 0, x, 1);
      }
   }
   
   public void fillMediumArray()
   {
      for (int x = 0; x < mediumArray.length; x++)
      {
         mediumArray[x] = new MediumEnemy(BFrame, 80*x, 0, x, 1);
      }  
   }
   ...
   public void fillHardArray()
   {
      ...
      {
         hardArray[x] = new HardEnemy(BFrame, 80*x, 0, x, 1);
      }      
   }
   ...
   public void checkTime()
   {
      ...
      time = "" + myMinutes_x + myMinutes_y + ":" + mySeconds_x + mySeconds_y;
   }
   ...
   public void run()
   {
      ...
      Timer EE = new Timer();
      EE.scheduleAtFixedRate(new EasyEnemyUpdater(), 0, 30);
      Timer ME = new Timer();
      ME.scheduleAtFixedRate(new MediumEnemyUpdater(), 0, 30);
      Timer HE = new Timer();
      HE.scheduleAtFixedRate(new HardEnemyUpdater(), 0, 30);
      
      Timer clock = new Timer();
      clock.scheduleAtFixedRate(new SpecialThread(), 0, 1000);
      Timer clock_two = new Timer();
      clock_two.scheduleAtFixedRate(new EasyThread(), 0, 500);
      Timer clock_three = new Timer();
      clock_three.scheduleAtFixedRate(new MediumThread(), 0, 1000);
      Timer clock_four = new Timer();
      clock_four.scheduleAtFixedRate(new HardThread(), 0, 1000);
